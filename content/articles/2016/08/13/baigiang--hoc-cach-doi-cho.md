...
plugins: [youtube]
youtubeIDs: ["4BxuTDj5vS4"]
url: /baigiang/hoc-cach-doi-cho/
draft: false
---
...
1. **Tự kiểm soát được bản thân** — Cảm xúc đẩy chúng ta đến những hành động mà chúng ta không thể kiểm soát. Sự chờ đợi dạy chúng ta sự tự chế.
2. **Tinh thần kiên nhẫn** — Kiên nhẫn là một trong những điều mà chúng ta đang thiếu, bởi vì cái gì cũng vội vã cho nên chúng ta không học được cách kiên nhẫn.
3. **Thử rèn đức tin** — Đi với Chúa phải học tập sự kiên nhẫn. Nếu chúng ta cứ vội vã thực hiện theo ý mình muốn, chúng ta sẽ thất bại.
4. **Nếm trải niềm hy vọng** — Sự chờ đợi càng lâu, niềm hy vọng càng được nhen nhúm và bùng cháy lên.
